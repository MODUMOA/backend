...
public interface PaymentService {
    ...
    List<TrashHistoryItem> getTrashHistoryByIdx(int userIdx, int trashIdx) throws Exception;

    // user테이블 exp UPDATE
    void updateUserExp(UserExpItem userExpItem) throws Exception;

    // 두 날짜 간 차이 구하기
    int getDateDiff(String date1, String date2) throws Exception;

    // 사용자 exp 구하기
    int getUserExp(int userIdx) throws Exception;

    // 사용자 exp UPDATE ( 10000 빼기 )
